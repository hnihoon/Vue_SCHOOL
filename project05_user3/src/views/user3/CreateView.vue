        ...
        <div class="container">
          <form>
            ...
            <tr>
                ...
                <td>
                    <input type="email" id="email" name="email" placeholder="이메일 입력하세요" class="form-control" autocomplete="off" v-model="result.email" :class="{active:active.email}">
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" id="radio1" name="gender" value="1" v-model="result.gender">
                    <label for="radio1">남성</label>
                    &nbsp;&nbsp;&nbsp;
                    <input type="radio" id="radio2" name="gender" value="0" v-model="result.gender">
